...
function TEsound.play(sound, tags, volume, pitch, func)
	...
	if not sounddata[sound] then
		sounddata[sound]=love.sound.newSoundData(sound)
	end
	table.insert(TEsound.channels, { love.audio.newSource(sounddata[sound]), func, {volume or 1, pitch or 1}, tags=(type(tags) == "table" and tags or {tags}) })
